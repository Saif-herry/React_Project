...
const Apod_Foter = () => {
  return (
    <div className='apod_foter'>
      ...
      <p style={{fontWeight:"bold"}}><span >NASA Official:</span> Phillip Newman <Link>Specific rights apply.</Link></p>
      <p style={{fontWeight:"bold"}}><Link>NASA Web Privacy Policy and Important Notices</Link></p>
      <p style={{fontWeight:"bold"}}><span >A service of:</span> <Link>ASD</Link> at <Link>NASA / GSFC,</Link></p>
